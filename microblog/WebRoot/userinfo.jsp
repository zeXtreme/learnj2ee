<%@page import="me.zwy.vo.UserInfo"%>
  ...
  <body>
    <div id="body">
		...
		<div id="main">
			...
			<div id="center">
				<h1>用户:<%=ud.findById(userId).getUserName() %></h1>
				<a href="follow?userid=${param.userid}">关注此用户</a>
				<%
				for(Content content : new UserInfo().getContents(ud.findById(userId))){
				 %>
				<ul>
					<li>
						<p><a href="userinfo.jsp?userid=${param.userid}"><%=ud.findById(userId).getUserName() %></a>:<%=content.getContent() %></p>
