    ...
    <div id="body">
		...
		<div id="main">
			...
			<div id="center">
				<p>您发表的微博：</p>
				<%
				for(Content content : new MyPost().getContents(user)){
				 %>
				<ul>
					<li>
						...
						<p><a href="content.jsp?pid=<%=content.getPid() %>">评论(<%=content.getComment().size() %>)</a>&nbsp;<a href="delete?pid=<%=content.getPid() %>">删除</a></p>
					</li>
				</ul>
				<%
				}
